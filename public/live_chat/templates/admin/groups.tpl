			...
			<div class="row-fluid">
				...
				<div class="span12">
					...
					<ul class="breadcrumb">
						...
						<li class="active"><?php translate('Groups'); ?></li>
					</ul>
					...
					<?php if ($row_count > 0): ?>
						...
						<div class="well">
							...
							<form method="post">
								...
								<a href="add_group.php" class="btn btn-default"><?php translate('Add group'); ?></a>
								<button class="btn btn-primary" id="delete"><?php translate('Delete'); ?></button>
								
								<table class="table">
									<thead>
										<tr>
											<th><input type="checkbox" value="cb_group" class="select_all"></th>
											<th><?php translate('Group name'); ?></th>
									...
									<tbody>
										<?php foreach ($user_groups as $value): ?>
											<tr>
												<td><input type="checkbox" value="<?php echo $value['group_id']; ?>" name="cb_group[]"></td>
												<td><?php echo $value['group_name']; ?></td>
												<td><a href="edit_group.php?group_id=<?php echo $value['group_id']; ?>" title="<?php translate('Edit group'); ?>"><i class="icon-edit"></i></a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
