			...
			<div class="row-fluid">
				...
				<div class="span12">
					...
					<ul class="breadcrumb">
						...
						<li class="active"><?php translate('Departments'); ?></li>
					</ul>
					...
					<?php if ($row_count > 0): ?>
						...
						<div class="well">
							...
							<form method="post">
								...
								<a href="add_department.php" class="btn btn-default"><?php translate('Add department'); ?></a>
								<button class="btn btn-primary" id="delete"><?php translate('Delete'); ?></button>
								
								<table class="table">
									<thead>
										<tr>
											<th><input type="checkbox" value="cb_department" class="select_all"></th>
											<th><?php translate('Department name'); ?></th>
									...
									<tbody>
										<?php foreach ($departments as $value): ?>
											<tr>
												<td><input type="checkbox" value="<?php echo $value['department_id']; ?>" name="cb_department[]"></td>
												<td><?php echo $value['department_name']; ?></td>
												<td><?php echo $value['department_email']; ?></td>
												<td><a href="edit_department.php?department_id=<?php echo $value['department_id']; ?>" title="<?php translate('Edit department'); ?>"><i class="icon-edit"></i></a></td>
											</tr>
										<?php endforeach; ?>
									</tbody>
								</table>
