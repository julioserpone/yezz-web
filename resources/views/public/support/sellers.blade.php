			...
			<script type='text/javascript'>
				...
				function init_map(){
					...
					jQuery.each(directions, function(i, val) {
						...
						var spInfo =name+'\n'+'Seller in '+val.country+' '+val.address+'\n'+phone;
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-8 col-sm-12 col-xs-12">
				<h2>{{ trans('message.sellers_authorized') }}</h2>
			</div>
			<div class="col-md-2"></div>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-2 col-sm-12 col-xs-12 text-center" style="margin-top: 5px;">
				<a class="btn btn-primary" onclick="showList('am','btn-am',0);" id="btn-am">{{ trans('message.africa_mest') }}</a>
			</div>
			<div class="col-md-2"></div>
		</div>
...
<script type="text/javascript">
	...
	{  
		...
		switch(reg){
			case "na":
			_reg = "{{trans('message.sellers_in')}}&nbsp;{{trans('message.america')}}";
			break;
			case "eu":
			_reg = "{{trans('message.sellers_in')}}&nbsp;{{trans('message.europe')}}";
			break;
			case "am":
			_reg = "{{trans('message.sellers_in')}}&nbsp;{{trans('message.africa_mest')}}";
			break;
		}
